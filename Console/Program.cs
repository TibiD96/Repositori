...
namespace RunningContest
{
    ...
    public class Program
    {
        ...
        public static void Print(ContestRanking contestRanking)
        {
            for (int x = 0; x < contestRanking.Contestants.Length; x++)
            {
                Contestant contestant = contestRanking.Contestants[x];
        ...
        public static void GenerateGeneralRanking(ref Contest contest)
        {
            ...
            contest = Sorting(finalRank);
            contest.GeneralRanking = contest.Series[0];
        }
        ...
        static Contest Sorting(Contest finalRank)
        {
            ...
            result = Union(tempStart, tempEnd);
            return result;
        }

        static Contest Union(Contest tempStart, Contest tempEnd)
        {
